...
const SignUpPage: React.FC = () => {
  ...
  function getPasswordStrength(pw: string) {
    if (pw.length < 6) return 'Faible';
    if (/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}$/.test(pw)) return 'Fort';
    if (pw.length >= 6) return 'Moyen';
    return '';
  }
      ...
      <div className="flex-1 flex flex-col md:flex-row items-center justify-center px-4 md:px-0">
        ...
        <div className="md:w-1/2 w-full flex flex-col justify-center items-start md:pl-24 md:pr-8 mb-8 md:mb-0">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-6 max-w-2xl">
            Démarrez votre voyage d'apprentissage personnalisé avec notre IA
          </p>
          <div className="mb-8">
        ...
        <div className="md:w-1/2 w-full flex justify-center items-center md:pl-8">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-blue-100 p-6">
            <h3 className="text-2xl font-bold text-blue-600 mb-6 text-center">Inscription</h3>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-lg bg-blue-50 border ${usernameError ? 'border-red-400 focus:border-red-500 focus:ring-red-200' : 'border-blue-100 focus:border-blue-500 focus:ring-blue-200'} focus:ring-2 placeholder-gray-500 outline-none transition text-base focus:shadow-lg`}
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg bg-blue-50 border border-blue-100 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 placeholder-gray-500 outline-none transition text-base focus:shadow-lg"
                />
              </div>
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-lg bg-blue-50 border ${passwordError ? 'border-red-400 focus:border-red-500 focus:ring-red-200' : 'border-blue-100 focus:border-blue-500 focus:ring-blue-200'} focus:ring-2 placeholder-gray-500 outline-none transition text-base pr-10 focus:shadow-lg`}
                    required
                  />
                  <button 
                    type="button" 
                ...
                {password && (
                  <div className="mt-1 text-xs">
                    <span className={`font-semibold ${passwordStrength === 'Fort' ? 'text-green-600' : passwordStrength === 'Moyen' ? 'text-yellow-600' : 'text-red-500'}`}>Force du mot de passe : {passwordStrength}</span>
                  </div>
                )}
              </div>
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-lg bg-blue-50 border ${confirmError ? 'border-red-400 focus:border-red-500 focus:ring-red-200' : 'border-blue-100 focus:border-blue-500 focus:ring-blue-200'} focus:ring-2 placeholder-gray-500 outline-none transition text-base pr-10 focus:shadow-lg`}
                    required
                  />
                  <button 
                    type="button" 
